...
[EPSON's V800](document/machine/EPSON_V800/test.txt) scanners are the ones used as this document is being written. The scanner model isn't important but we recommend to use scanners with a transparent (double-lamp) option. This will allow cleaner root scans for complex root systems.
...
Detailed `XnConvert` tutorial is available [HERE](document/software/XnConvert/test.txt).
