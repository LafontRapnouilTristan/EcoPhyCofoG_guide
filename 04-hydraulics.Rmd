...
* Test Water Quality [*cf Vapro_cheatsheet*](document/machine/Vapro 5520)
* Clean 
* Calibration [*cf Vapro_cheatsheet*](document/machine/Vapro 5520)
* Control tests [*cf Vapro_cheatsheet*](document/machine/Vapro 5520)
* Verify temperature
...
* Beware of the stuck leaf inside the vapro! If so [*cf Vapro_cheatsheet*](document/machine/Vapro 5520)
...
For more information on the vapro machine, please refer to the [*cf Vapro_cheatsheet*](document/machine/Vapro 5520). 
